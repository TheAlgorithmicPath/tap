...
import { createTopicPage } from "../../../actions/admin/topicpage";
...
const TopicPageCreate = () => {
  //   const navigate = useNavigate();
  // const { DSA, CSF, LANG, PROJ } = useSelector((state) => state.topicsContent);
  ...
  const submitHandler = async (e) => {
    ...
    dispatch(createTopicPage(allIds, subject));
  };

  useEffect(() => {
    if (subject !== "") {
      dispatch(getArticlesBySubject(subject));
      dispatch(getVideosBySubject(subject));
      dispatch(getQuestionsBySubject(subject));
    }
  ...
  return (
    <div className="ContentCreate">
      <div className="ContentCreate_container">
        <p className="heading_page">Add Topic Page</p>
...
export default TopicPageCreate;
