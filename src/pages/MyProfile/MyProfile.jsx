...
const MyProfile = () => {
  ...
  const [contributionCnt, setContributionCnt] = useState(0);
  ...
  useEffect(() => {
    if (!user) {
      ...
      setContributionCnt(
        user?.contribution.articles.length +
          user?.contribution.questions.length +
          user?.contribution.videos.length
      );
          ...
          <div className="profile__container">
            <div className="profile">
              <img
                ...
                src={user?.avatar?.url ? avatarPreview : defaultAvatar}
                alt="profile-img"
              />
              <div className="profile__name__email">
                ...
                <h3 style={{ marginTop: "10px" }} className="profile__name">
                  Total Contributions : {contributionCnt}
                </h3>
              </div>
            </div>
